...
public class Climb_ClimbProvider : MonoBehaviour
{
    ...
    private void Start()
    {
        Climb_XRDirectClimbInteractor.ClimbHandActivated += HandActivated;
        Climb_XRDirectClimbInteractor.ClimbHandDeactivated += HandDeactivated;
    }
